    ...
    <section class="flex flex-col md:flex-row gap-4">
        ...
        <div class="mt-2 flex justify-center">
            ...
            <form method="POST" action="{{route('profile.update')}}" enctype="multipart/form-data">
                ...
                border rounded focus:outline-none">Save</button>
            </form>
        </div>
        {{--Job Listings--}}
    <div class="bg-white p-8 rounded-lg shadow-md w-full">
        ...
        @forelse($jobs as $job)
            ...
            <div class="flex space-x-3">
                <a href="{{route('jobs.edit',$job->id)}}"
                   class="bg-blue-500 text-white px-4 py-2 rounded mt-4">Edit</a>
        ...
        <div class="mt-4 bg-gray-100 p-2">
            ...
            @empty
                <p class="text-gray-700 mt-5" >No applicants for this job</p>
            @endforelse
        </div>
        @empty
            <p class="text-gray-700">You don't have a job listing.</p>
        @endforelse
    </div>
    </section>
    <x-bottom-banner/>
